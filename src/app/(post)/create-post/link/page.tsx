          ...
          <div className={cx("home-content")}>
            ...
            <div className="w-[732px]">
              ...
              <div className="relative my-5">
                <input type="text" id="floating_filled" className="block px-2.5 pb-2.5 pt-5 w-full border border-black rounded-2xl focus:outline-none focus:ring-0 peer" placeholder=" " />
