...
const InputComment = () => {
    ...
    return (
        <div className="border border-gray-300 rounded-2xl comment-input mt-5">
            {!isFormat ? (<textarea className="w-full h-[84px] p-2 rounded-lg bg-transparent text-gray-900" />) : (<TextEditor editorData={content} setEditorData={setContent} />)}
            <div className="flex flex-row justify-between mt-5 py-1 px-2">
                <button onClick={() => setIsFormat(!isFormat)} className="w-8 aspect-square rounded-full hover:bg-gray-400 text-gray-600 flex items-center justify-center">
                    <svg fill="currentColor" height="16" icon-name="format-outline" viewBox="0 0 20 20" width="16" xmlns="http://www.w3.org/2000/svg">
...
const PostMenu = ({ isOpen, onEdit, onDelete }: {
    isOpen: boolean;
    onEdit: () => void;
    onDelete: () => void;
}) => {
    ...
    return (
        <div className="absolute right-0 top-10 bg-white rounded-xl shadow-lg z-50">
            <div className="py-1 text-gray-700">
                ...
                >
                    <svg className="px-1" fill="currentColor" height="32" icon-name="edit-outline" viewBox="0 0 20 20" width="32" xmlns="http://www.w3.org/2000/svg">
                ...
                <button
                    onClick={onDelete}
                    className="w-full px-4 py-2 text-left hover:text-gray-900 flex items-center gap-2"
                >
                    <svg className="px-1" fill="currentColor" height="32" icon-name="delete-outline" viewBox="0 0 20 20" width="32" xmlns="http://www.w3.org/2000/svg">
...
const mockComments = [
  {
    id: 1,
    user: {
      avatar: '/general/image4.png',
      name: 'rez410',
    },
    time: '2d ago',
    content: 'Are they making you pay the $100k?',
    votes: 482,
    children: [
      {
        id: 2,
        ...
        time: '2d ago',
        content: 'Yeah, OP, try to negotiate with them a way lower, reasonable amount. No one in their right mind would expect a person to pay 100k for something like that.',
        votes: 444,
        children: [],
      },
    ],
  },
  {
    ...
    time: '2d ago',
    content: 'I am also interested in this.',
    votes: 131,
    children: [
      {
        id: 4,
        ...
        time: '2d ago',
        content: 'In discussions. Will update when resolved.',
        votes: 395,
        children: [
          {
            id: 5,
...
function Comment({ comment, level = 0 }: { comment: CommentType; level?: number }) {
  ...
  return (
    ...
    <div className={cn('flex', level > 0 ? 'ml-8' : '', 'mb-4')}> 
      <Image src={comment.user.avatar} alt="avatar" className="w-8 h-8 rounded-full border border-gray-300" width={32} height={32} />
      ...
      <div className="ml-3 flex-1">
        ...
        <div className="flex items-center gap-2 mt-2 text-gray-500 text-sm">
          <div className={cn("bg-[#e5ebee] flex flex-row items-center justify-center rounded-full ease-in-out duration-100", vote === 0 && "bg-[#D93900]", vote === 1 && "bg-[#6A3CFF]")}> 
            <button onClick={handleUpVote} className={cn("hover:bg-[#f7f9fa] rounded-full p-2 text-black w-8 h-8 ease-in-out duration-100", vote === null && "hover:text-[#D93900]", vote === 0 && "hover:bg-[#532DFF] text-white", vote === 1 && "hover:bg-[#AE2C00]")}> 
              {vote === 0 ? (
            ...
            <span className={cn("text-xs font-semibold", (vote === 0 || vote === 1) ? "text-white" : "text-black")}>{getVoteCount()}</span>
            <button onClick={handleDownVote} className={cn("hover:bg-[#f7f9fa] rounded-full p-2 text-black w-8 h-8", vote === null && "hover:text-[#6A3CFF]", vote === 1 && "hover:bg-[#532DFF] text-white", vote === 0 && "hover:bg-[#AE2C00]")}> 
              {vote === 1 ? (
          ...
          <a href="#" className="bg-[#e5ebee] hover:bg-[#f7f9fa] flex flex-row items-center justify-center rounded-full h-8 px-3 py-2 text-sm active:bg-[#FFFFFF26]">
        ...
        <div className={cx("home-wrapper")}>
          <div className={cx("container")}>
            <div className={cx("home-content")}>
              <Sidebar />
        <div className="flex flex-col max-w-[732px]">
            <div className="pt-2 pb-0 px-2 my-2 w-full max-w-[732px] bg-white rounded-xl">
                <div className="flex flex-row justify-between items-center mb-4 relative">
                    <div className="flex flex-row items-center gap-1 text-gray-500 text-xs font-semibold">
                        <div className="flex flex-row items-center gap-2 text-gray-900 cursor-pointer">
                            <svg className="bg-gray-200 rounded-full p-2 hover:bg-gray-300 ease-in-out duration-100" fill="currentColor" height="32" icon-name="back-outline" viewBox="0 0 20 20" width="32" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZw4HYx8PHlE8ZniW1hqck5nZeKaYZSqG56g&s" alt="avatar" className="w-8 h-8 rounded-full" width={32} height={32} />
                            <p className="hover:text-blue-600">John Doe</p>
                        </div>
                        <span>•</span>
                    ...
                    <div ref={menuRef} className="relative">
                        ...
                        >
                            <svg fill="currentColor" height="16" icon-name="overflow-horizontal-fill" viewBox="0 0 20 20" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-row mt-4 gap-3">
                    ...
                    <a href="#" className="bg-gray-200 hover:bg-gray-300 flex flex-row items-center justify-center rounded-full px-3 active:bg-gray-100">
                        ...
                        <span className="text-gray-900 text-xs font-semibold">100</span>
                    </a>
            ...
            <div className="mt-10">
                <div className="mb-4 flex items-center gap-2">
                    ...
                    {/* <input
                        ...
                        className="border border-gray-300 rounded px-3 py-1 text-sm ml-auto"
                    /> */}
                </div>
                <div>
