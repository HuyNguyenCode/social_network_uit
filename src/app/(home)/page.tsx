...
export default function Home() {
  ...
  //fetch userinfor
  // const [arrUser, setArrUser] = useState<string[]>([]);
  // console.log("arrUser", arrUser);
  const arrUser: { userId: string; postId: string }[] = [];
  console.log("arrUser", arrUser);
      ...
      <div className={cx("container")}>
        <div className={cx("home-content")}>
          ...
          <div className={cx("middle-content")}>
            {data.map((post) => {
              // setArrUser((prev) => [...prev, post.createdBy]);
              arrUser.push({ userId: post.createdBy, postId: post.id });
              return (
                  ...
                  <div className={cx("post-header")}>
                    <div className={cx("left-content-header")}>
                      <Image
                        ...
                        height={24}
                      />
                      <h5 className={cx("name")}>test</h5>
                      <span className={cx("dot")}></span>
                      <h6 className={cx("time")}>
                        {dayjs(post.createdOn).fromNow()}
                      </h6>
                    </div>
                    <div className={cx("right-content-header")}>
                      <button className={cx("follow-button")}>
                      ...
                      <button className={cx("three-dot-button")}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                          height="20"
                  ...
                  <div className={cx("post-container")}>
                    ...
                    <div className={cx("post-interact")}>
                      <div className={cx("post-interact-item")}>
                        <div className={cx("post-interact-item-icon")}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="14"
                            height="14"
                        ...
                        <span className={cx("post-interact-text")}>
                          {post.upvoteCount}
                        </span>
                        <div className={cx("post-interact-item-icon")}>
                          <svg
                      ...
                      <div className={cx("post-interact-item")}>
                        <div className={cx("post-interact-item-icon")}>
                          ...
                          >
                            <path
                              d="M4.29688 10.3556V10.3341L4.28057 10.3201C3.55577 9.69652 2.99938 8.90076 2.66253 8.00595C2.32569 7.11114 2.21922 6.14601 2.3529 5.19929C2.48658 4.25258 2.85613 3.35466 3.42757 2.58811C3.99901 1.82156 4.754 1.21097 5.62311 0.812497C6.49222 0.414019 7.44757 0.240439 8.40131 0.307717C9.35505 0.374995 10.2766 0.680971 11.0811 1.19751C11.8857 1.71405 12.5475 2.42458 13.0057 3.26376C13.4638 4.10294 13.7037 5.04384 13.7031 5.99995V5.99998C13.7032 6.82047 13.526 7.63128 13.1837 8.37691C12.8413 9.12255 12.3418 9.78539 11.7195 10.32L11.7031 10.3341V10.3556V15C11.7031 15.1197 11.6724 15.2375 11.614 15.3421C11.5557 15.4467 11.4716 15.5347 11.3697 15.5977C11.2678 15.6607 11.1515 15.6966 11.0318 15.702C10.9122 15.7074 10.7931 15.6822 10.6859 15.6287L8.02096 14.2968L8 14.2863L7.97904 14.2968L5.31467 15.6287L5.31465 15.6287C5.20746 15.6823 5.08833 15.7077 4.96859 15.7023C4.84884 15.697 4.73245 15.6611 4.63048 15.5981C4.5285 15.5351 4.44432 15.4471 4.38593 15.3424C4.32755 15.2377 4.29689 15.1198 4.29688 15V10.3556ZM3.70313 5.99998V6.00003C3.7043 7.13926 4.15737 8.23149 4.96293 9.03705C5.76849 9.84261 6.86072 10.2957 7.99995 10.2969H8C8.84984 10.2969 9.6806 10.0448 10.3872 9.5727C11.0938 9.10055 11.6446 8.42947 11.9698 7.64432C12.295 6.85917 12.3801 5.99521 12.2143 5.1617C12.0485 4.32819 11.6393 3.56256 11.0384 2.96163C10.4374 2.3607 9.67179 1.95146 8.83828 1.78567C8.00477 1.61987 7.14081 1.70496 6.35566 2.03018C5.57051 2.3554 4.89943 2.90615 4.42728 3.61276C3.95513 4.31938 3.70313 5.15014 3.70313 5.99998ZM10.229 13.8288L10.2969 13.8627V13.7869V11.2912V11.2204L10.2317 11.2481C9.52591 11.5482 8.7669 11.7029 8 11.7029C7.23311 11.7029 6.47409 11.5482 5.76834 11.2481L5.70313 11.2204V11.2912V13.7862V13.8621L5.77096 13.8282L7.68471 12.8713L7.68473 12.8713C7.78241 12.8224 7.89014 12.7969 7.99938 12.7969C8.10861 12.7969 8.21634 12.8224 8.31402 12.8713L8.31404 12.8713L10.229 13.8288ZM9.77956 8.66328C9.25282 9.01523 8.63355 9.20309 8.00005 9.2031C7.15082 9.20213 6.33665 8.86433 5.73615 8.26383C5.13564 7.66333 4.79785 6.84916 4.79688 5.99992C4.79689 5.36643 4.98475 4.74715 5.3367 4.22042C5.68866 3.69367 6.18892 3.28311 6.77422 3.04068C7.35951 2.79824 8.00355 2.73481 8.6249 2.8584C9.24624 2.98199 9.81699 3.28706 10.265 3.73503C10.7129 4.18299 11.018 4.75373 11.1416 5.37508C11.2652 5.99643 11.2017 6.64047 10.9593 7.22576C10.7169 7.81106 10.3063 8.31132 9.77956 8.66328ZM8.99829 4.50593C8.7028 4.30849 8.35539 4.2031 8 4.2031C7.52344 4.2031 7.0664 4.39242 6.72942 4.7294C6.39244 5.06638 6.20313 5.52342 6.20313 5.99998C6.20313 6.35537 6.30851 6.70277 6.50595 6.99827C6.7034 7.29376 6.98403 7.52407 7.31237 7.66007C7.6407 7.79608 8.00199 7.83166 8.35055 7.76233C8.69911 7.69299 9.01929 7.52186 9.27058 7.27056C9.52188 7.01926 9.69302 6.69909 9.76235 6.35053C9.83168 6.00197 9.7961 5.64068 9.6601 5.31234C9.5241 4.98401 9.29379 4.70337 8.99829 4.50593ZM13.2263 8.39647C13.5714 7.6447 13.7501 6.82721 13.75 5.99998L11.75 10.3556C12.3775 9.81654 12.8811 9.14825 13.2263 8.39647Z"
                              fill="#475569"
                              stroke="#475569"
                              strokeWidth="0.09375"
                            />
            ...
            <div className={cx("post")}>
              <div className={cx("post-header")}>
                <div className={cx("left-content-header")}>
                  <Image
                    ...
                    height={24}
                  />
                  <h5 className={cx("name")}>s/singularity</h5>
                  <span className={cx("dot")}></span>
                  <h6 className={cx("time")}>6 hr ago</h6>
                </div>
                <div className={cx("right-content-header")}>
                  <button className={cx("follow-button")}>
                    <span className={cx("follow-text")}>Follow</span>
              ...
              <div className={cx("post-container")}>
                <div className={cx("post-container-with-img")}>
                  <div className={cx("post-left-content")}>
                    <h4 className={cx("post-title")}>
                      Guy with fear of heights gets the courage make it to the
                      cliffside view{" "}
                    </h4>
                  ...
                  <div className={cx("post-right-content")}>
                    <Image
                ...
                <div className={cx("post-interact")}>
                  <div className={cx("post-interact-item")}>
                    ...
                    <span className={cx("post-interact-text")}>8,2K</span>
                    <div className={cx("post-interact-item-icon")}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
          ...
          <div className={cx("right-content")}>
            <div className={cx("recent-post-header")}>
              <span className={cx("recent-post-header-text")}>
                Recent Posts
              </span>
            ...
            <div className={cx("recent-post")}>
              ...
              <div className={cx("recent-post-content")}>
                ...
                <p className={cx("post-content")}>
                  I like movies where they start out in a way that you think
                  you're in for a typical movie where you have a pretty good
                  idea how{" "}
                </p>
              </div>
            </div>
